...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (main) {
      if (window.location.pathname.endsWith('/index.html') || window.location.pathname.endsWith('/warenkorb.html')|| window.location.pathname.endsWith('/about.html') || window.location.pathname.endsWith('/agb.html') || window.location.pathname.endsWith('/impressum.html') || window.location.pathname.endsWith('/placedorder.html') || !window.location.pathname.endsWith('/links.html') || !window.location.pathname.endsWith('.html')) {
        main.innerHTML = `
